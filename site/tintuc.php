    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 col-lg-9 col-sm-12 col-xs-12">
                <div class="single-blog text-center wow fadeIn" style="visibility: visible; animation-name: none;">
                    <div class="image">
                        <img src="img/blog/main_blog/blog_1.jpg">
                    </div>

                    <div class="blog-details">
                        <div class="title-and-meta">
                            <h3><a href="single-blog.html">Education for the Children</a></h3>
                            <p class="post-meta">28/1/2017</p>
                        </div>
                ...
                <div class="single-blog text-center wow fadeIn" style="visibility: visible; animation-name: none;">
                    ...
                    <div class="blog-details">
                        <div class="title-and-meta">
                            <h3><a href="single-blog.html">Education for the Children</a></h3>
                            <p class="post-meta">By <a href="#">Alexander Pirlo</a> | <a href="#">July 28, 2016</a></p>
                        </div>
                        <div class="blog-content">
                            <p>Donec finibus sit amet orci eget ultricies. Praesent posuere ante ut erat fringilla, vestibulum placerat metus mattis. Aenean dictum vitae nisl nec tempor. Proin varius turpis ut sem porttitor varius. Sed aliquet libero ultrices consectetur. Vivamus egestas, metus quis egestas egestas tortor justo pharetra diam, et dapibus massa nibh dapibus</p>
            ...
            <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                <div class="blog-sidebar">
                    <div class="single-sidebar-widget social-widget wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                    ...
                    <div class="single-sidebar-widget post-widget wow fadeIn" style=" animation-name: none;">
